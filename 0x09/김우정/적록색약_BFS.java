...
public class Main {
    public static void main(String[] args)throws IOException {
        ...
        int countArea = countArea_BFS(board, boardSize);
        int countAreaB = countArea_BFS(boardBlindness, boardSize);
    ...
    public static int countArea_BFS(char[][] board, int boardSize){
